...
ALTER TABLE "Orders" ADD "PaymentResponse" TEXT NULL;

ALTER TABLE "Orders" ADD "PaymentStatus" INTEGER NOT NULL DEFAULT 0;

ALTER TABLE "Orders" ADD "TransactionId" TEXT NULL;

ALTER TABLE "OrderDetails" ADD "SelectedOptions" TEXT NOT NULL DEFAULT '';

ALTER TABLE "Categories" ADD "Description" TEXT NULL;

CREATE TABLE "ef_temp_Products" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_Products" PRIMARY KEY AUTOINCREMENT,
    "CanCustomize" INTEGER NOT NULL,
    "CategoryId" INTEGER NOT NULL,
    "Description" TEXT NOT NULL,
    "HasSizeOptions" INTEGER NOT NULL,
    "ImageUrl" TEXT NULL,
...
INSERT INTO "ef_temp_Products" ("Id", "CanCustomize", "CategoryId", "Description", "HasSizeOptions", "ImageUrl", "IsAvailable", "IsFeatured", "Name", "PrepTime", "Price")
SELECT "Id", "CanCustomize", "CategoryId", "Description", "HasSizeOptions", "ImageUrl", "IsAvailable", "IsFeatured", "Name", "PrepTime", "Price"
FROM "Products";

CREATE TABLE "ef_temp_ProductReviews" (
...
INSERT INTO "ef_temp_ProductReviews" ("Id", "Comment", "CreatedAt", "ProductId", "Rating", "UserId")
SELECT "Id", "Comment", "CreatedAt", "ProductId", "Rating", "UserId"
FROM "ProductReviews";

CREATE TABLE "ef_temp_ProductOptions" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ProductOptions" PRIMARY KEY AUTOINCREMENT,
    "AdditionalPrice" decimal(18,2) NOT NULL,
...
INSERT INTO "ef_temp_ProductOptions" ("Id", "AdditionalPrice", "Description", "IsDefault", "Name", "OptionType", "ProductId")
SELECT "Id", "AdditionalPrice", "Description", "IsDefault", "Name", "OptionType", "ProductId"
FROM "ProductOptions";

CREATE TABLE "ef_temp_ProductImages" (
...
INSERT INTO "ef_temp_ProductImages" ("Id", "ImageUrl", "ProductId")
...
INSERT INTO "ef_temp_Orders" ("Id", "City", "Email", "FirstName", "IsGuestOrder", "LastName", "Notes", "OrderDate", "PaymentMethod", "PaymentResponse", "PaymentStatus", "PhoneNumber", "ShippingAddress", "State", "TotalPrice", "TransactionId", "UserId", "ZipCode")
SELECT "Id", "City", "Email", "FirstName", "IsGuestOrder", "LastName", "Notes", "OrderDate", "PaymentMethod", "PaymentResponse", "PaymentStatus", "PhoneNumber", "ShippingAddress", "State", "TotalPrice", "TransactionId", "UserId", "ZipCode"
FROM "Orders";
...
INSERT INTO "ef_temp_OrderDetails" ("Id", "OrderId", "Price", "ProductId", "Quantity", "SelectedOptions")
SELECT "Id", "OrderId", "Price", "ProductId", "Quantity", "SelectedOptions"
FROM "OrderDetails";
...
INSERT INTO "ef_temp_Categories" ("Id", "Description", "Name")
...
INSERT INTO "ef_temp_AspNetUsers" ("Id", "AccessFailedCount", "Address", "Age", "AvatarUrl", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName")
SELECT "Id", "AccessFailedCount", "Address", "Age", "AvatarUrl", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName"
FROM "AspNetUsers";
...
ALTER TABLE "ef_temp_ProductReviews" RENAME TO "ProductReviews";

DROP TABLE "ProductOptions";

ALTER TABLE "ef_temp_ProductOptions" RENAME TO "ProductOptions";

DROP TABLE "ProductImages";

ALTER TABLE "ef_temp_ProductImages" RENAME TO "ProductImages";
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250406060548_FixSqliteTypes', '9.0.3');

BEGIN TRANSACTION;
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250406060559_AddSelectedOptionsToOrderDetail', '9.0.3');
