    ...
    <HeaderContainer>
      ...
      <MobileMenu isOpen={mobileMenuOpen}>
        ...
        <MobileNavLinks>
          ...
          <MobileNavItem>
            <Link to="/rewards" onClick={toggleMobileMenu}>Rewards</Link>
          </MobileNavItem>
          <MobileNavItem>
            <Link to="/gift-cards" onClick={toggleMobileMenu}>Gift Cards</Link>
          </MobileNavItem>
        </MobileNavLinks>
        
        <MobileActionButtons>
          <SignInButton to="/signin" onClick={toggleMobileMenu} style={{ display: 'inline-block', textAlign: 'center' }}>Sign in</SignInButton>
          <JoinNowButton to="/join" onClick={toggleMobileMenu} style={{ display: 'inline-block', textAlign: 'center' }}>Join now</JoinNowButton>
