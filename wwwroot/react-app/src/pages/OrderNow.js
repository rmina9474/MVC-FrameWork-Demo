...
const nearbyStores = [
  {
    ...
    image: 'https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-67628.jpg'
  },
  {
    id: 2,
    ...
    image: 'https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-67619.jpg'
  },
  {
    id: 3,
    ...
    image: 'https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-67627.jpg'
  }
];
...
const orderOptions = [
  {
    ...
    description: 'Save time by ordering ahead on the Starbucks® app. Just order, pay, and pick up your favorites without waiting in line.',
    image: 'https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-67671.jpg',
    cta: 'Order Now',
    link: '/menu'
  },
  {
    id: 2,
    title: 'Get Delivery',
    description: 'Have your Starbucks favorites delivered to your door. Just use the Starbucks® app or your favorite delivery service.',
    image: 'https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-67672.jpg',
    cta: 'Order Delivery',
    link: '/delivery'
  },
  {
    id: 3,
    title: 'Drive-Thru',
    description: 'Grab your favorites without leaving your car. Use the app to find Drive-Thru locations near you.',
    image: 'https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-67663.jpg',
    cta: 'Find Drive-Thru',
    link: '/store-locator'
  }
];
    ...
    <OrderNowContainer>
      <HeroSection>
        <HeroContent>
          ...
          <HeroSubtitle>Save time with easy mobile ordering and contactless pickup options.</HeroSubtitle>
        </HeroContent>
      </HeroSection>
      ...
      <StoreFinderSection>
        ...
        <MapContainer>
          <MapPlaceholder>
            ...
            <p style={{ marginTop: '12px' }}>Search for stores to see the map</p>
          </MapPlaceholder>
        </MapContainer>
        
        <SectionTitle style={{ fontSize: '1.75rem' }}>Nearby Stores</SectionTitle>
        <StoreList>
          {nearbyStores.map(store => (
            <StoreCard key={store.id}>
              ...
              <StoreDetails>
                  ...
                  {store.features.map((feature, index) => (
                    <FeatureTag key={index}>
                      {feature === 'Mobile Order & Pay' ? (
                        ...
                        <>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.5 7L5.5 5H18.5L16.5 7H7.5Z" fill="currentColor" />
                            <path d="M16.5 10H7.5L6.5 19H17.5L16.5 10Z" fill="currentColor" />
                          </svg>
                        </>
                      ) : (
                        <>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.5 22V20H3.5V18H5.5V16H7.5V18H9.5V20H7.5V22H5.5ZM11.5 22V20H9.5V18H11.5V16H13.5V18H15.5V20H13.5V22H11.5ZM17.5 22V20H15.5V18H17.5V16H19.5V18H21.5V20H19.5V22H17.5ZM3.5 14V3C3.5 2.45 3.95 2 4.5 2H14.5L20.5 8V14H3.5ZM14.5 8H19.1L14.5 3.4V8Z" fill="currentColor" />
                          </svg>
                        </>
                      )}
                      {feature}
                ...
                <StoreActions>
                  <SecondaryButton to={`/stores/${store.id}`}>Store Details</SecondaryButton>
                  <PrimaryButton to={`/order/${store.id}`}>Order Now</PrimaryButton>
                </StoreActions>
              </StoreDetails>
            </StoreCard>
          ))}
