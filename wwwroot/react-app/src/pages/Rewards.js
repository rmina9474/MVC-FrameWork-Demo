...
const rewardsData = [
  ...
  },
  {
    ...
    description:
      "Treat yourself to a pastry, a packaged snack or a hot cup of coffee or tea. Or keep cool with an iced coffee or iced tea.",
    image:
  ...
  },
  {
    ...
    description:
      "Enjoy a well-deserved lunch on us. Choose from one of our savory protein boxes, sandwiches or salads.",
    image:
  ...
  return (
    <RewardsContainer>
      <HeroSection>
        ...
        <HeroSubtitle>
          Join Starbucks Rewards to earn Stars for free food and drinks, get
          access to mobile ordering, exclusive offers and more.
        </HeroSubtitle>
      ...
      <CalloutSection>
        <CalloutContainer>
          ...
          <CalloutDescription>
            ...
            benefits. Order and pay ahead on the app, get access to special
            offers, birthday Rewards, and more.
          </CalloutDescription>
          <JoinButton
            to="/join"
            style={{ backgroundColor: "#00754a", color: "white" }}
          >
            Join now
          </JoinButton>
        </CalloutContainer>
