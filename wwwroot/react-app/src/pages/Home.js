...
const promotions = [
  {
    ...
    cta: "Order now",
    image:
      "https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-88168.jpg",
    link: "/menu",
    bgColor: "#ebc8ed",
    textColor: "#1e3932",
    reversed: false,
  },
  {
    ...
    cta: "Learn more",
    image:
      "https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-88437.jpg",
    link: "/menu",
    bgColor: "#d4e9e2",
    textColor: "#1e3932",
    reversed: true,
  },
  {
    ...
    cta: "Order now",
    image:
      "https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-88037.jpg",
    link: "/menu",
    bgColor: "#ff9ed1",
    textColor: "#1e3932",
    reversed: false,
  },
  {
    ...
    cta: "Join now",
    image:
      "https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-88028.jpg",
    link: "/rewards",
    bgColor: "#1e3932",
    textColor: "#ffffff",
    reversed: true,
